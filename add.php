...
if (isset($_POST['delete_expense'])) {
    ...
    $delete_query = "DELETE FROM expenses WHERE user_id = $user_id AND id = $expense_id";
                ...
                <?php while ($row = $ledger->fetch_assoc()): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center bg-dark text-white">
                        <span>
                            ...
                            <?php echo htmlspecialchars($row['expense_name'], ENT_QUOTES, 'UTF-8'); ?>
                        </span>
                        <span class="fw-bold">
                        ...
                        <form method="POST" class="ml-2" style="display:inline;">
                            ...
                            <button type="submit" name="delete_expense" class="btn-delete btn-sm">
